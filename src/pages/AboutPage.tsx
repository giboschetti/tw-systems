...
export const AboutPage = () => {
  ...
  return (
    <div className="bg-white">
      {/* Hero Section */}
      <section className="bg-gradient-to-b from-primary to-darkBlue text-white py-20">
          ...
          >
            ...
            <div className="flex justify-center space-x-4">
              <motion.button
                ...
                className="bg-white text-primary px-6 py-3 rounded-lg font-semibold shadow-lg hover:bg-gray-100 transition-colors"
              >
                {language === 'en' ? 'Contact Us' : 'Kontaktieren Sie uns'}
              </motion.button>
              <motion.button
                whileHover={{ scale: 1.05 }}
                className="border-2 border-white px-6 py-3 rounded-lg font-semibold shadow-lg hover:bg-white/10 transition-colors"
              >
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            >
              <div className="flex items-center mb-6">
                <MissionIcon />
                <h2 className="text-3xl font-bold ml-4 text-darkBlue">
            ...
            >
              <div className="grid grid-cols-2 gap-4">
                ...
                >
                  <RailwayIcon />
                  <h3 className="text-xl font-semibold mt-4 text-darkBlue">
                ...
                >
                  <div className="flex items-center">
                    <svg className="w-12 h-12 text-primary mr-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            {parsedContent.values.map((value: any, index: number) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="text-2xl font-bold mb-4 text-darkBlue">{value.title}</h3>
