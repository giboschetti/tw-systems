      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              <h2 className="text-2xl font-bold text-darkBlue mb-6 font-montserrat">
              ...
              <form onSubmit={handleSubmit}>
                <div className="grid md:grid-cols-2 gap-6 mb-6">
                  {/* Full Name */}
                  <div>
                    <label htmlFor="fullName" className="block text-gray-700 font-medium mb-2 font-montserrat">
                  ...
                  {/* Phone */}
                  <div>
                    <label htmlFor="phone" className="block text-gray-700 font-medium mb-2 font-montserrat">
                  ...
                  {/* Company */}
                  <div>
                    <label htmlFor="company" className="block text-gray-700 font-medium mb-2 font-montserrat">
                  ...
                  {/* Project Name */}
                  <div>
                    <label htmlFor="projectName" className="block text-gray-700 font-medium mb-2 font-montserrat">
                ...
                {/* Products */}
                <div className="mb-6">
                  <label className="block text-gray-700 font-medium mb-2 font-montserrat">
                  ...
                  <div className="grid md:grid-cols-2 gap-2">
                    {productOptions.map(product => (
                      <div key={product.id} className="flex items-center">
                        ...
                        />
                        <label htmlFor={product.id} className="ml-2 text-sm text-gray-700 font-opensans">
                          {product.name}
                        </label>
                      </div>
                    ))}
                ...
                <div className="mb-6">
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    rows={6}
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-secondary resize-none font-opensans"
                ...
                <div className="text-center">
                  <motion.button
                    ...
                    className="bg-secondary text-white px-8 py-3 rounded-lg font-semibold shadow-lg hover:bg-accent transition-colors disabled:opacity-70 disabled:cursor-not-allowed font-montserrat"
                  >
                    {isSubmitting ? (
            ...
            >
              ...
              <div className="space-y-6">
                ...
                <div className="flex">
                  ...
                  <div className="ml-4">
                    <h3 className="text-lg font-semibold text-darkBlue font-montserrat">
                      {language === 'en' ? 'Address' : 'Adresse'}
                    </h3>
                    <p className="text-gray-600 mt-1 font-opensans">TW Solutions ÖU</p>
                    <p className="text-gray-600 font-opensans">Sepapaja tn 6, 15551</p>
                    <p className="text-gray-600 font-opensans">Tallinn, Estonia</p>
                  </div>
                </div>
                ...
                <div className="flex">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600 mt-1 font-opensans">
                      <a href="mailto:kontakt@tw-systems.ch" className="text-secondary hover:underline">
                ...
                <div className="flex">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600 mt-1 font-opensans">
                      <a href="https://www.tw-systems.ch" target="_blank" rel="noopener noreferrer" className="text-secondary hover:underline">
                        www.tw-systems.ch
                      </a>
                    </p>
                  </div>
                ...
                <div className="flex">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600 mt-1 font-opensans">
                      <a href="mailto:support@tw-systems.ch" className="text-secondary hover:underline">
              ...
              {/* Map */}
              <div className="mt-8">
                <h3 className="text-lg font-semibold text-darkBlue mb-4 font-montserrat">
